  ...
  <header className={cn(" w-full items-center gap-4  bg-background px-4 md:px-6 z-50 h-16 transition-shadow duration-200 flex", isTop ? "shadow-none" : "shadow-sm")}>
    ...
    <div className="flex items-center justify-end gap-2 md:ml-auto text-primary">
      ...
      <a href="https://github.com/jiakun93/favicon-downloader" className="flex flex-shrink-0">
        <img title="Favicon Downloader Github" alt="Favicon Downloader Github" height={20} className="h-[20px]" src="https://img.shields.io/github/stars/jiakun93/favicon-downloader?style=social" />
      </a>
    </div>
  </header>
  )
